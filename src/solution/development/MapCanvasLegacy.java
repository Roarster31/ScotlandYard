 ...
 */
@Deprecated
public class MapCanvasLegacy extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private String viewType = HighwayControlUI.PREVIEW;
	...
	private void doDrawing(Graphics g) {
        ...
        if(!viewType.equals(HighwayControlUI.PREVIEW)){
        ...
        for(PathEdge edge : mEdgeList){
            ...
            if(HighwayControlUI.EDIT_PATH_TOOL.equals(mCurrentTool) && stroke.createStrokedShape(polyLine).contains(mouseX, mouseY) && viewType.equals(HighwayControlUI.PREVIEW)){
        ...
        if(!viewType.equals(HighwayControlUI.PREVIEW)){
            ...
            if(viewType.equals(HighwayControlUI.EDIT_NODES)){
	...
	private void addNode(int x, int y){
        ...
        }else if(viewType.equals(HighwayControlUI.EDIT_NODES) || viewType.equals(HighwayControlUI.VIEW_UNDERGROUND)){
	...
	private void endMoveNode(final int x, final int y) {
        ...
        if(viewType.equals(HighwayControlUI.EDIT_NODES) || viewType.equals(HighwayControlUI.VIEW_UNDERGROUND)) {
            for(PathNode node : mNodeList){
                if(node.getShape().contains(x,y)){
	...
	public void deleteNode(PathNode node){
        ...
        }else if(viewType.equals(HighwayControlUI.EDIT_NODES)){
